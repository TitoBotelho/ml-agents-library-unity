...
namespace Unity.MLAgentsExamples
{
    ...
    public class ModelOverrider : MonoBehaviour
    {
        ...
        Dictionary<string, Unity.Barracuda.NNModel> m_CachedModels = new Dictionary<string, Unity.Barracuda.NNModel>();
        ...
        public Unity.Barracuda.NNModel GetModelForBehaviorName(string behaviorName)
        {
        ...
        Unity.Barracuda.NNModel LoadSentisModel(byte[] rawModel)
        {
            // Note: In Unity 2022.3, direct byte array loading is not supported for NNModel
            // This method returns null and should be replaced with proper model loading
            // from Resources or StreamingAssets folders
            Debug.LogWarning("LoadSentisModel: Direct byte array loading not supported in Unity 2022.3. Use Resources.Load or load from file path instead.");
            return null;
        }
        ...
        void OverrideModel()
        {
            ...
            Unity.Barracuda.NNModel nnModel = null;
            try
            {
