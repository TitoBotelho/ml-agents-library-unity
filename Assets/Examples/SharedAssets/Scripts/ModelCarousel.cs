...
public class ModelCarousel : MonoBehaviour
{
    ...
    private void Reset()
    {
        ...
        m_Agent.SetModel(m_OriginalModel.name, m_OriginalModel as Unity.Barracuda.NNModel);
    ...
    void SetModel()
    {
        ...
        m_Agent.SetModel(m_Models[m_CurrentModelIndex].name, m_Models[m_CurrentModelIndex] as Unity.Barracuda.NNModel);
