...
public class WallJumpAgent : Agent
{
    ...
    public override void Initialize()
    {
        ...
        // Note: Model switching is now handled directly through BehaviorParameters in Unity 2022.3
        // The ModelOverrider component can still be used but models are set via inspector
    }
    ...
    void ConfigureAgent(int config)
    {
        ...
        if (config == 0)
        {
            ...
            // Note: In Unity 2022.3, behavior switching is handled via BehaviorParameters
        }
        else if (config == 1)
        {
            localScale = new Vector3(
